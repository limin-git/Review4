...
public:
    ...
    virtual boost::program_options::variables_map& variables_map() { return m_variables_map; }
    virtual boost::program_options::options_description& options_description() { return m_options_description; }
